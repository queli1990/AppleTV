...
var product_successTemplate = function (genre_id,description,bigDic,relatedArray) {
...
var relatedTemplate = function (relatedArray) {
  ...
  return relatedTemplateArray.join('');
}
